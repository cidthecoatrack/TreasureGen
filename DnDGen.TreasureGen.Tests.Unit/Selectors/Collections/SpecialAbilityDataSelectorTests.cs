...
namespace DnDGen.TreasureGen.Tests.Unit.Selectors.Collections
{
    ...
    public class SpecialAbilityDataSelectorTests
    {
        ...
        public void ReturnSpecialAbilityAttributesResult()
        {
            ...
            mockInnerSelector.Setup(s => s.SelectFrom(Config.Name, TableNameConstants.Collections.SpecialAbilityData, "name")).Returns(attributes);
        ...
        {
            mockInnerSelector.Setup(s => s.IsCollection(Config.Name, TableNameConstants.Collections.SpecialAbilityData, "name")).Returns(true);
        ...
        {
            mockInnerSelector.Setup(s => s.IsCollection(Config.Name, TableNameConstants.Collections.SpecialAbilityData, "name")).Returns(false);
            var isSpecialAbility = selector.IsSpecialAbility("name");
